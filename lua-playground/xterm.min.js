		...
		var e = {
				...
				9631: (e, t) => {
					Object.defineProperty(t, '__esModule', { value: !0 }), t.removeElementFromParent = void 0, t.removeElementFromParent = function (...e) {
						var t;
						for (const i of e)
							null === (t = null == i ? void 0 : i.parentElement) || void 0 === t || t.removeChild(i);
					};
				},
				3656: (e, t) => {
					...
					class I extends w.CoreTerminal {
						...
						bindMouse() {
							...
							this.register(this.coreMouseService.onProtocolChange(e => {
								...
								if (e.preventDefault(), this.focus(), this.coreMouseService.areMouseEventsActive && !this._selectionService.shouldForceSelection(e))
									return i(e), s.mouseup && this._document.addEventListener('mouseup', s.mouseup), s.mousedrag && this._document.addEventListener('mousemove', s.mousedrag), this.cancel(e);
						...
						_keyDown(e) {
							if (this._keyDownHandled = !1, this._keyDownSeen = !0, this._customKeyEventHandler && !1 === this._customKeyEventHandler(e))
								return !1;
						...
						addDecoration(e) {
							if (e.options.overviewRulerOptions) {
								...
								if (this._zonePoolIndex < this._zonePool.length)
									return this._zonePool[this._zonePoolIndex].color = e.options.overviewRulerOptions.color, this._zonePool[this._zonePoolIndex].position = e.options.overviewRulerOptions.position, this._zonePool[this._zonePoolIndex].startBufferLine = e.marker.line, this._zonePool[this._zonePoolIndex].endBufferLine = e.marker.line, void this._zones.push(this._zonePool[this._zonePoolIndex++]);
								this._zones.push({
				...
				9504: (e, t, i) => {
					...
					function a(e, t, i, s, r, n) {
						let o = e, a = t, h = '';
						for (; o !== i || a !== s;)
							o += r ? 1 : -1, r && o > n.cols - 1 ? (h += n.buffer.translateBufferLineToString(a, !1, e, o), o = 0, e = 0, a++) : !r && o < 0 && (h += n.buffer.translateBufferLineToString(a, !1, 0, e + 1), o = n.cols - 1, e = o, a--);
					...
					let g = 1, p = class extends _.Disposable {
							...
							_updateDimensions() {
								...
								for (const e of this._rowElements)
									e.style.width = `${ this.dimensions.css.canvas.width }px`, e.style.height = `${ this.dimensions.css.cell.height }px`, e.style.lineHeight = `${ this.dimensions.css.cell.height }px`, e.style.overflow = 'hidden';
							...
							handleSelectionChanged(e, t, i) {
								...
								if (this._rowFactory.handleSelectionChanged(e, t, i), this.renderRows(0, this._bufferService.rows - 1), !e || !t)
									return;
							...
							_setCellUnderline(e, t, i, s, r, n) {
								if (e = this._cellToRowElements[i][e], t = this._cellToRowElements[s][t], -1 !== e && -1 !== t)
									for (; e !== t || i !== s;) {
					...
					let f = class {
						...
						createRow(e, i, s, r, a, h, l, _, f) {
							...
							for (; b < S; b++) {
								...
								if (_ > 1 && (E.style.width = l * _ + 'px'), S && (E.style.display = 'inline', a >= b && a <= y && (a = b)), !this._coreService.isCursorHidden && s && b === a)
									switch (E.classList.add(t.CURSOR_CLASS), h && E.classList.add(t.CURSOR_BLINK_CLASS), r) {
									case 'bar':
						...
						_applyMinimumContrast(e, t, i, s, r, n) {
							if (1 === this._optionsService.rawOptions.minimumContrastRatio || (0, _.excludeFromContrastRatioDemands)(s.getCode()))
								return !1;
							let o;
					...
					let u = class extends a.Disposable {
						constructor(e, t, i, s, r, a, l, d) {
							if (super(), this._rowCount = e, this._charSizeService = s, this._pausedResizeTask = new _.DebouncedIdleTask(), this._isPaused = !1, this._needsFullRefresh = !1, this._isNextRenderRedrawOnly = !0, this._needsSelectionRefresh = !1, this._canvasWidth = 0, this._canvasHeight = 0, this._selectionState = {
								...
								const e = new l.window.IntersectionObserver(e => this._handleIntersectionChange(e[e.length - 1]), { threshold: 0 });
				...
				9312: function (e, t, i) {
					...
					let p = class extends u.Disposable {
						...
						_selectWordAtCursor(e, t) {
							...
							if (r)
								return this._model.selectionStart = [
									r.start.x - 1,
									r.start.y - 1
				...
				8055: (e, t, i) => {
					...
					t.NULL_COLOR = {
						...
						e.toColor = function (e) {
							...
							if (s)
								return r = parseInt(s[1]), n = parseInt(s[2]), o = parseInt(s[3]), a = Math.round(255 * (void 0 === s[5] ? 1 : parseFloat(s[5]))), l.toColor(r, n, o, a);
							if (!t || !i)
						...
						function t(e, t, i) {
							...
							return 0.2126 * (s <= 0.03928 ? s / 12.92 : Math.pow((s + 0.055) / 1.055, 2.4)) + 0.7152 * (r <= 0.03928 ? r / 12.92 : Math.pow((r + 0.055) / 1.055, 2.4)) + 0.0722 * (n <= 0.03928 ? n / 12.92 : Math.pow((n + 0.055) / 1.055, 2.4));
						}
						...
						function t(e, t, i) {
							...
							for (; l < i && (o > 0 || a > 0 || h > 0);)
								o -= Math.max(0, Math.ceil(0.1 * o)), a -= Math.max(0, Math.ceil(0.1 * a)), h -= Math.max(0, Math.ceil(0.1 * h)), l = _(c.relativeLuminance2(o, a, h), c.relativeLuminance2(s, r, n));
						...
						function i(e, t, i) {
							...
							for (; l < i && (o < 255 || a < 255 || h < 255);)
								o = Math.min(255, o + Math.ceil(0.1 * (255 - o))), a = Math.min(255, a + Math.ceil(0.1 * (255 - a))), h = Math.min(255, h + Math.ceil(0.1 * (255 - h))), l = _(c.relativeLuminance2(o, a, h), c.relativeLuminance2(s, r, n));
							return (o << 24 | a << 16 | h << 8 | 255) >>> 0;
						}
					...
					class m extends s.Disposable {
						...
						_enableWindowsMode() {
							if (!this._windowsMode) {
								const e = [];
								e.push(this.onLineFeed(f.updateWindowsModeWrappedState.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: 'H' }, () => ((0, f.updateWindowsModeWrappedState)(this._bufferService), !1))), this._windowsMode = {
									dispose: () => {
										for (const t of e)
											t.dispose();
									}
					...
					class E extends h.Disposable {
						...
						_logSlowResolvingAsync(e) {
							this._logService.logLevel <= v.LogLevelEnum.WARN && Promise.race([
								e,
								new Promise((e, t) => setTimeout(() => t('#SLOW_TIMEOUT'), 5000))
							]).catch(e => {
								if ('#SLOW_TIMEOUT' !== e)
									throw e;
								...
								if (o && this._onA11yChar.fire((0, c.stringFromCodePoint)(s)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), r || !this._activeBuffer.x) {
									if (this._activeBuffer.x + r - 1 >= a)
										if (h) {
											...
											continue;
									if (l && (u.insertCells(this._activeBuffer.x, r, this._activeBuffer.getNullCell(d), d), 2 === u.getWidth(a - 1) && u.setCellFromCodePoint(a - 1, _.NULL_CELL_CODE, _.NULL_CELL_WIDTH, d.fg, d.bg, d.extended)), u.setCellFromCodePoint(this._activeBuffer.x++, s, r, d.fg, d.bg, d.extended), r > 0)
										for (; --r;)
						...
						eraseInDisplay(e, t = !1) {
							...
							case 0:
								for (i = this._activeBuffer.y, this._dirtyRowTracker.markDirty(i), this._eraseInBufferLine(i++, this._activeBuffer.x, this._bufferService.cols, 0 === this._activeBuffer.x, t); i < this._bufferService.rows; i++)
									this._resetBufferLine(i, t);
								this._dirtyRowTracker.markDirty(i);
								break;
							case 1:
								for (i = this._activeBuffer.y, this._dirtyRowTracker.markDirty(i), this._eraseInBufferLine(i, 0, this._activeBuffer.x + 1, !0, t), this._activeBuffer.x + 1 >= this._bufferService.cols && (this._activeBuffer.lines.get(i + 1).isWrapped = !1); i--;)
									this._resetBufferLine(i, t);
						...
						insertLines(e) {
							...
							for (; t--;)
								this._activeBuffer.lines.splice(r - 1, 1), this._activeBuffer.lines.splice(i, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
						...
						deleteLines(e) {
							...
							let s;
							for (s = this._bufferService.rows - 1 - this._activeBuffer.scrollBottom, s = this._bufferService.rows - 1 + this._activeBuffer.ybase - s; t--;)
								this._activeBuffer.lines.splice(i, 1), this._activeBuffer.lines.splice(s, 0, this._activeBuffer.getBlankLine(this._eraseAttrData()));
							return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.y, this._activeBuffer.scrollBottom), this._activeBuffer.x = 0, !0;
						}
						insertChars(e) {
							this._restrictCursor();
				...
				7226: (e, t, i) => {
					...
					class r {
						...
						_process(e) {
							...
							for (; this._i < this._tasks.length;) {
								if (t = Date.now(), this._tasks[this._i]() || this._i++, t = Math.max(1, Date.now() - t), i = Math.max(t, i), r = e.timeRemaining(), 1.5 * i > r)
									return s - t < -20 && console.warn(`task queue exceeded allotted deadline by ${ Math.abs(Math.round(s - t)) }ms`), void this._start();
								s = r;
							}
							this.clear();
						}
				...
				9092: (e, t, i) => {
					...
					t.MAX_BUFFER_SIZE = 4294967295, t.Buffer = class {
							...
							if (n > this.lines.maxLength && (this.lines.maxLength = n), this.lines.length > 0) {
								...
								if (this._rows < t)
									for (let s = this._rows; s < t; s++)
										this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode ? this.lines.push(new r.BufferLine(e, i)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + o + 1 ? (this.ybase--, o++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new r.BufferLine(e, i)));
								else
						...
						_reflowLargerAdjustViewport(e, t, i) {
							...
							let n = i;
							for (; n-- > 0;)
								0 === this.ybase ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new r.BufferLine(e, s))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
						...
						_reflowSmaller(e, t) {
							...
							for (let o = this.lines.length - 1; o >= 0; o--) {
								...
								let C = u - f;
								for (; C-- > 0;)
									0 === this.ybase ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + n) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++);
						...
						stringIndexToBufferIndex(e, t, i = !1) {
							for (; t;) {
								...
								for (let i = 0; i < r; ++i)
									if (s.get(i)[o.CHAR_DATA_WIDTH_INDEX] && (t -= s.get(i)[o.CHAR_DATA_CHAR_INDEX].length || 1), t < 0)
										return [
											e,
											i
										];
						...
						setupTabStops(e) {
							for (null != e ? this.tabs[e] || (e = this.prevStop(e)) : (this.tabs = {}, e = 0); e < this._cols; e += this._optionsService.rawOptions.tabStopWidth)
								this.tabs[e] = !0;
						}
						prevStop(e) {
				...
				8437: (e, t, i) => {
					...
					class h {
						...
						replaceCells(e, t, i, s, r = !1) {
							if (r)
								for (e && 2 === this.getWidth(e - 1) && !this.isProtected(e - 1) && this.setCellFromCodePoint(e - 1, 0, 1, (null == s ? void 0 : s.fg) || 0, (null == s ? void 0 : s.bg) || 0, (null == s ? void 0 : s.extended) || new o.ExtendedAttrs()), t < this.length && 2 === this.getWidth(t - 1) && !this.isProtected(t) && this.setCellFromCodePoint(t, 0, 1, (null == s ? void 0 : s.fg) || 0, (null == s ? void 0 : s.bg) || 0, (null == s ? void 0 : s.extended) || new o.ExtendedAttrs()); e < t && e < this.length;)
									this.isProtected(e) || this.setCell(e, i), e++;
							else
								for (e && 2 === this.getWidth(e - 1) && this.setCellFromCodePoint(e - 1, 0, 1, (null == s ? void 0 : s.fg) || 0, (null == s ? void 0 : s.bg) || 0, (null == s ? void 0 : s.extended) || new o.ExtendedAttrs()), t < this.length && 2 === this.getWidth(t - 1) && this.setCellFromCodePoint(t, 0, 1, (null == s ? void 0 : s.fg) || 0, (null == s ? void 0 : s.bg) || 0, (null == s ? void 0 : s.extended) || new o.ExtendedAttrs()); e < t && e < this.length;)
									this.setCell(e++, i);
						}
						resize(e, t) {
							if (e === this.length)
				...
				7116: (e, t) => {
					Object.defineProperty(t, '__esModule', { value: !0 }), t.DEFAULT_CHARSET = t.CHARSETS = void 0, t.CHARSETS = {}, t.DEFAULT_CHARSET = t.CHARSETS.B, t.CHARSETS[0] = {
						...
						'}': '\xA3',
						'~': '\xB7'
					}, t.CHARSETS.A = { '#': '\xA3' }, t.CHARSETS.B = void 0, t.CHARSETS[4] = {
						'#': '\xA3',
						'@': '\xBE',
						'[': 'ij',
						'\\': '\xBD',
				...
				2584: (e, t) => {
					...
					Object.defineProperty(t, '__esModule', { value: !0 }), t.C1_ESCAPED = t.C1 = t.C0 = void 0, function (e) {
						e.NUL = '\0', e.SOH = '\x01', e.STX = '\x02', e.ETX = '\x03', e.EOT = '\x04', e.ENQ = '\x05', e.ACK = '\x06', e.BEL = '\x07', e.BS = '\b', e.HT = '\t', e.LF = '\n', e.VT = '\x0B', e.FF = '\f', e.CR = '\r', e.SO = '\x0E', e.SI = '\x0F', e.DLE = '\x10', e.DC1 = '\x11', e.DC2 = '\x12', e.DC3 = '\x13', e.DC4 = '\x14', e.NAK = '\x15', e.SYN = '\x16', e.ETB = '\x17', e.CAN = '\x18', e.EM = '\x19', e.SUB = '\x1A', e.ESC = '\x1B', e.FS = '\x1C', e.GS = '\x1D', e.RS = '\x1E', e.US = '\x1F', e.SP = ' ', e.DEL = '\x7F';
						...
						default:
							if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey)
								if (i && !n || !e.altKey || e.metaKey)
									!i || e.altKey || e.ctrlKey || e.shiftKey || !e.metaKey ? e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && 1 === e.key.length ? o.key = e.key : e.key && e.ctrlKey && ('_' === e.key && (o.key = s.C0.US), '@' === e.key && (o.key = s.C0.NUL)) : 65 === e.keyCode && (o.type = 1);
								else {
						...
						decode(e, t) {
							...
							for (; d < i;) {
								...
								if (s = e[d++], s < 128)
									...
									if (h = (15 & s) << 12 | (63 & r) << 6 | 63 & n, h < 2048 || h >= 55296 && h <= 57343 || 65279 === h)
										continue;
									t[a++] = h;
								} else if (240 == (248 & s)) {
									if (d >= i)
									...
									if (d >= i)
										return this.interim[0] = s, this.interim[1] = r, this.interim[2] = n, a;
									if (o = e[d++], 128 != (192 & o)) {
										d--;
										continue;
									}
									if (h = (7 & s) << 18 | (63 & r) << 12 | (63 & n) << 6 | 63 & o, h < 65536 || h > 1114111)
										continue;
									t[a++] = h;
								}
							}
						...
						write(e, t) {
							...
							if (!this._writeBuffer.length) {
								if (this._bufferOffset = 0, this._didUserInput)
									return this._didUserInput = !1, this._pendingData += e.length, this._writeBuffer.push(e), this._callbacks.push(t), void this._innerWrite();
				...
				5770: (e, t) => {
					Object.defineProperty(t, '__esModule', { value: !0 }), t.PAYLOAD_LIMIT = void 0, t.PAYLOAD_LIMIT = 10000000;
				},
				6351: (e, t, i) => {
					...
					t.DcsParser = class {
						...
						put(e, t, i) {
							if (this._active.length)
								...
								this._handlerFb(this._ident, 'PUT', (0, s.utf32ToString)(e, t, i));
						}
						unhook(e, t = !0) {
							if (this._active.length) {
								...
								if (this._stack.paused && (s = this._stack.loopPosition - 1, i = t, r = this._stack.fallThrough, this._stack.paused = !1), !r && !1 === i) {
									for (; s >= 0 && (i = this._active[s].unhook(e), !0 !== i); s--)
										if (i instanceof Promise)
											return this._stack.paused = !0, this._stack.loopPosition = s, this._stack.fallThrough = !1, i;
									s--;
								}
								for (; s >= 0; s--)
							...
							if (this._parseStack.state)
								if (2 === this._parseStack.state)
									...
									case 4:
										...
										break;
									case 6:
										if (r = e[this._parseStack.chunkPos], s = this._dcsParser.unhook(24 !== r && 26 !== r, i), s)
											return s;
					...
					let _ = class extends a.Disposable {
						...
						triggerMouseEvent(e) {
							...
							if (4 !== e.button && (2 === e.action || 3 === e.action))
								return !1;
							if (e.col++, e.row++, 32 === e.action && this._lastEvent && this._equalEvents(this._lastEvent, e, 'SGR_PIXELS' === this._activeEncoding))
								return !1;
				...
				6975: function (e, t, i) {
					...
					const n = i(2585), o = i(8460), a = i(1439), h = i(844), c = Object.freeze({ insertMode: !1 }), l = Object.freeze({
					...
					class c extends n.Disposable {
						...
						*getDecorationsAtCell(e, t, i) {
							...
							for (const h of this._decorations.getKeyIterator(t))
								o = null !== (s = h.options.x) && void 0 !== s ? s : 0, a = o + (null !== (r = h.options.width) && void 0 !== r ? r : 1), e >= o && e < a && (!i || (null !== (n = h.options.layer) && void 0 !== n ? n : 'bottom') === i) && (yield h);
						}
